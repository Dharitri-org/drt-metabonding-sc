WALLET_PEM="/home/dharitri/dharitri-sdk/mxpy-venv/lib/python3.8/site-packages/mxpy/testnet/wallets/users/mike.pem"
...
TOKEN_DECIMALS=18
issueToken() {
    mxpy --verbose contract call ${DCT_ISSUE_ADDRESS} --recall-nonce \
        --pem=${WALLET_PEM} \
        --gas-limit=60000000 \
        --proxy=${PROXY} --chain=${CHAIN_ID} \
