...
use dharitri_sc_scenario::{managed_address, managed_buffer, rust_biguint};
...
fn claim_partial_ok_test() {
    ...
    mb_setup
        .b_mock
        .check_dct_balance(&first_user_addr, FIRST_PROJ_TOKEN, &rust_biguint!(0));
    mb_setup.b_mock.check_dct_balance(
        &first_user_addr,
        SECOND_PROJ_TOKEN,
