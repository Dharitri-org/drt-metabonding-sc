    ...
    + crate::validation::ValidationModule
{
    ...
    /// - total_delegation_supply - The total amount of staked MOAX in the Delegation SC
    ...
    /// Gets rewards for the given week, assuming the user has the given staked MOAX and LKMEX amounts.
